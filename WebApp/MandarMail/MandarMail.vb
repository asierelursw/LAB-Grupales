...
Public Class MandarMail
    Public Function enviarEmail(receiver As String, subject As String, body As String) As Boolean
        Try
            'Direccion de origen
            Dim from_address As New Net.Mail.MailAddress("esalgueira001@ikasle.ehu.eus", "Elur Salgueira")
            'Direccion de destino
            Dim to_address As New Net.Mail.MailAddress(receiver)
            'Password de la cuenta
            Dim from_pass As String = "070054hmK2020"
