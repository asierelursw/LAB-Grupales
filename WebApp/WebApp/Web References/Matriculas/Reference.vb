...
Namespace Matriculas
    ...
    Partial Public Class Matriculas
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.WebApp.My.MySettings.Default.WebApp_Matriculas_Matriculas
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("https://ehusw.es/jav/ServiciosWeb/comprobarmatricula.php/comprobar", RequestNamespace:="https://ehusw.es/jav/ServiciosWeb/comprobarmatricula.php?wsdl", ResponseNamespace:="https://ehusw.es/jav/ServiciosWeb/comprobarmatricula.php?wsdl")>  _
